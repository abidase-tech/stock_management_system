...
import 'package:stockmanagementsystem/pages/product/item_list_page.dart';
import 'package:stockmanagementsystem/widgets/containers/statistics_widget.dart';

class ProductManagementDashboard extends StatelessWidget {
  static const routeName = "/products/dashboard";
  @override
                    ...
                    child: InkWell(
                      ...
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => ProductItemListView(),
                        ));
                      },
                      child: Container(
